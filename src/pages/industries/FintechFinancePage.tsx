    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
                ...
                <button className="w-full py-7 flex items-center justify-between gap-6 text-left group" onClick={() => setOpenVertical(openVertical === i ? null : i)}>
                  <div className="flex items-center gap-5">
                    <motion.span
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <motion.span animate={{ color: openVertical === i ? "#00d4aa" : "rgba(255,255,255,0.4)" }}>
                        {String(i + 1).padStart(2, "0")}
                      </motion.span>
                    </motion.span>
      ...
      <section ref={sec6Ref} className="section-forced-dark section-padding py-32">
        <div className="max-w-[1800px] mx-auto">
          ...
          <motion.p className="text-muted-foreground leading-relaxed mt-16 max-w-3xl" initial={{ opacity: 0 }} animate={sec6InView ? { opacity: 1 } : {}} transition={{ duration: 0.8, delay: 0.8 }}>
            From concept to launch, we develop fintech software that streamlines financial processes, interconnects seamlessly with your existing systems, and scales with your business.
          </motion.p>
        </div>
      </section>
